...
namespace Borodar.ScreenShooter.Utils
{
    public static class ScreenshotUtil
    {
        ...
        public static void TakeScreenshot(Camera camera, string folderName, string prefix, string suffix, ScreenshotConfig screenshotConfig)
        {
            ...
            var imageFilePath = folderName + "/" + MakeValidFileName(fileName + ".jpg");
            ScreenCapture.CaptureScreenshot(imageFilePath);

            //SaveTextureAsFile(ScreenCapture.CaptureScreenshotAsTexture(), folderName, prefix, suffix, screenshotConfig);
        }
